...
VALUES (123, '方舟', 'ark', '', '{\"support_sp\": true, \"function_call\": true, \"search_enhance\": false, \"support_stream\": true}', '{\"ark\": {\"region\": \"\", \"access_key\": \"1ea0e64a-cef2-4f29-b96b-effaf97667ba\", \"secret_key\": \"\"}, \"model\": \"ep-20250623194625-rszwf\", \"api_key\": \"1ea0e64a-cef2-4f29-b96b-effaf97667ba\", \"base_url\": \"\"}', 1, '', 0, 0, NULL)
ON DUPLICATE KEY UPDATE
   id = VALUES(id);

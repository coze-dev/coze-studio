...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'agent_to_database info';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Draft Agent Tool';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Agent Tool Version';
...
CREATE TABLE IF NOT EXISTS `api_key` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'api key table';
...
CREATE TABLE IF NOT EXISTS `app_connector_release_ref` (
  ...
  `updated_at` bigint unsigned NOT NULL DEFAULT 0 COMMENT 'Update Time in Milliseconds',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uk_record_connector` (`record_id`, `connector_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Connector Release Record Reference';
...
CREATE TABLE IF NOT EXISTS `app_draft` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Draft Application';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'draft database info';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '文档审阅表';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '知识库文件切片表';
...
CREATE TABLE IF NOT EXISTS `model_meta` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_status` (`status`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '模型元信息';
...
CREATE TABLE IF NOT EXISTS `node_execution` (
  ...
  `composite_node_index` bigint unsigned NULL COMMENT 'loop or batch execution index',
  `composite_node_items` mediumtext NULL COMMENT 'the items extracted from parent composite node for this index',
  `parent_node_id` varchar(128) NULL COMMENT 'when as inner node for loop or batch, this is the parent node key',
...
CREATE TABLE IF NOT EXISTS `online_database_info` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_space_app_creator_deleted` (`space_id`, `app_id`, `creator_id`, `deleted_at`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'online database info';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Latest Plugin';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Draft Plugin';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Plugin OAuth Authorization Code Info';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Plugin Version';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT 'bot快捷指令表';
...
CREATE TABLE IF NOT EXISTS `single_agent_draft` (
  ...
  INDEX `idx_creator_id` (`creator_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Single Agent Draft Copy Table';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'bot 渠道和发布版本流水表';
...
CREATE TABLE IF NOT EXISTS `single_agent_version` (
  ...
  `shortcut_command` json NULL COMMENT 'shortcut command',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uk_agent_id_and_version_connector_id` (`agent_id`, `version`, `connector_id`),
  INDEX `idx_creator_id` (`creator_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Single Agent Version Copy Table';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Space Table';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Space Member Table';
...
CREATE TABLE IF NOT EXISTS `template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uk_agent_id` (`agent_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Template Info Table';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Latest Tool';
...
CREATE TABLE IF NOT EXISTS `tool_draft` (
  ...
  UNIQUE INDEX `uniq_idx_plugin_sub_url_method` (`plugin_id`, `sub_url`, `method`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Draft Tool';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Tool Version';
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  UNIQUE INDEX `uk_unique_name` (`unique_name`)
...
CREATE TABLE IF NOT EXISTS `variables_meta` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uk_project_key` (`biz_id`, `biz_type`, `version`),
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'workflow draft';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'workflow execution';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'workflow meta';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'workflow reference';
...
CREATE TABLE IF NOT EXISTS `workflow_version` (
  ...
  `canvas` mediumtext COMMENT '前端 schema',
  `input_params` mediumtext NULL COMMENT '输入参数',
  `output_params` mediumtext NULL COMMENT '输出参数',

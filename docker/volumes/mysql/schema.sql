...
CREATE TABLE IF NOT EXISTS `opencoze`.`agent_to_database`
(
  ...
  COLLATE utf8mb4_general_ci COMMENT "agent_to_database info";
-- Create "agent_tool_draft" table
CREATE TABLE IF NOT EXISTS `opencoze`.`agent_tool_draft`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`agent_tool_version`
(
    `id`            bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `agent_id`      bigint unsigned NOT NULL DEFAULT 0 COMMENT "Agent ID",
    `plugin_id`     bigint unsigned NOT NULL DEFAULT 0 COMMENT "Plugin ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`api_key`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`app_connector_release_ref`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`app_draft`
(
    ...
    `desc`       text            NULL COMMENT "Application Description",
    `created_at` bigint unsigned NOT NULL DEFAULT 0 COMMENT "Create Time in Milliseconds",
    `updated_at` bigint unsigned NOT NULL DEFAULT 0 COMMENT "Update Time in Milliseconds",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`app_release_record`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`conversation`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`data_copy_task`
(
  ...
  COLLATE utf8mb4_general_ci COMMENT "data方向复制任务记录表";
-- Create "draft_database_info" table
CREATE TABLE IF NOT EXISTS `opencoze`.`draft_database_info`
(
    `id`                  bigint unsigned NOT NULL COMMENT "ID",
  ...
  COLLATE utf8mb4_general_ci COMMENT "draft database info";
-- Create "knowledge" table
CREATE TABLE IF NOT EXISTS `opencoze`.`knowledge`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`knowledge_document`
(
    `id`             bigint unsigned NOT NULL COMMENT "主键ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`knowledge_document_review`
(
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "文档审阅表";
-- Create "knowledge_document_slice" table
CREATE TABLE IF NOT EXISTS `opencoze`.`knowledge_document_slice`
(
    `id`           bigint unsigned NOT NULL DEFAULT 0 COMMENT "主键ID",
    `knowledge_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT "knowledge id",
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "知识库文件切片表";
-- Create "message" table
CREATE TABLE IF NOT EXISTS `opencoze`.`message`
(
    `id`                bigint unsigned  NOT NULL AUTO_INCREMENT COMMENT "主键ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`model_entity`
(
    `id`             bigint unsigned NOT NULL COMMENT "主键ID",
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "模型信息";
-- Create "model_meta" table
CREATE TABLE IF NOT EXISTS `opencoze`.`model_meta`
(
    `id`          bigint unsigned NOT NULL COMMENT "主键ID",
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "模型元信息";
-- Create "node_execution" table
CREATE TABLE IF NOT EXISTS `opencoze`.`node_execution`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`online_database_info`
(
    `id`                  bigint unsigned NOT NULL COMMENT "ID",
    `app_id`              bigint unsigned NULL COMMENT "App ID",
    `space_id`            bigint unsigned NOT NULL COMMENT "Space ID",
  ...
  COLLATE utf8mb4_general_ci COMMENT "online database info";
-- Create "plugin" table
CREATE TABLE IF NOT EXISTS `opencoze`.`plugin`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`plugin_draft`
(
    `id`           bigint unsigned NOT NULL DEFAULT 0 COMMENT "Plugin ID",
    `space_id`     bigint unsigned NOT NULL DEFAULT 0 COMMENT "Space ID",
    `developer_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT "Developer ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`plugin_oauth_auth`
(
    `id`                    bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`plugin_version`
(
    `id`           bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `space_id`     bigint unsigned NOT NULL DEFAULT 0 COMMENT "Space ID",
    `developer_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT "Developer ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`prompt_resource`
(
  ...
  COLLATE utf8mb4_0900_ai_ci COMMENT "prompt_resource";
-- Create "run_record" table
CREATE TABLE IF NOT EXISTS `opencoze`.`run_record`
(
    `id`              bigint unsigned  NOT NULL COMMENT "主键ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`shortcut_command`
(
    `id`               bigint unsigned  NOT NULL AUTO_INCREMENT COMMENT "主键ID",
  ...
  COLLATE utf8mb4_general_ci COMMENT "bot快捷指令表";
-- Create "single_agent_draft" table
CREATE TABLE IF NOT EXISTS `opencoze`.`single_agent_draft`
(
    `id`                         bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
    ...
    `database`                   json            NULL COMMENT "Agent Database Base Configuration",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`single_agent_publish`
(
    `id`            bigint unsigned NOT NULL AUTO_INCREMENT COMMENT "主键id",
    `agent_id`      bigint unsigned NOT NULL DEFAULT 0 COMMENT "agent_id",
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "bot 渠道和发布版本流水表";
-- Create "single_agent_version" table
CREATE TABLE IF NOT EXISTS `opencoze`.`single_agent_version`
(
    `id`                         bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
    `agent_id`                   bigint          NOT NULL DEFAULT 0 COMMENT "Agent ID",
    `creator_id`                 bigint          NOT NULL DEFAULT 0 COMMENT "Creator ID",
...
-- Create "space" table
CREATE TABLE IF NOT EXISTS `opencoze`.`space`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`space_user`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`template`
(
    `id`                  bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
    `agent_id`            bigint          NOT NULL DEFAULT 0 COMMENT "Agent ID",
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "Template Info Table";
-- Create "tool" table
CREATE TABLE IF NOT EXISTS `opencoze`.`tool`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`tool_draft`
(
    `id`               bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Tool ID",
    `plugin_id`        bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Plugin ID",
    `created_at`       bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Create Time in Milliseconds",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`tool_version`
(
    `id`         bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `tool_id`    bigint unsigned NOT NULL DEFAULT 0 COMMENT "Tool ID",
    `plugin_id`  bigint unsigned NOT NULL DEFAULT 0 COMMENT "Plugin ID",
...
-- Create "user" table
CREATE TABLE IF NOT EXISTS `opencoze`.`user`
(
    `id`            bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`variable_instance`
(
    `id`            bigint unsigned  NOT NULL DEFAULT 0 COMMENT "主键ID",
  ...
  COLLATE utf8mb4_0900_ai_ci COMMENT "KV Memory";
-- Create "variables_meta" table
CREATE TABLE IF NOT EXISTS `opencoze`.`variables_meta`
(
    `id`            bigint unsigned  NOT NULL DEFAULT 0 COMMENT "主键ID",
  ...
  COLLATE utf8mb4_0900_ai_ci COMMENT "KV Memory meta";
-- Create "workflow_draft" table
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_draft`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_execution`
(
...
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_meta`
(
    `id`                bigint unsigned  NOT NULL COMMENT "workflow id",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_reference`
(
    `id`                 bigint unsigned  NOT NULL COMMENT "workflow id",
...
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_snapshot`
(
  ...
  COLLATE utf8mb4_unicode_ci COMMENT "snapshot for executed workflow draft";
-- Create "workflow_version" table
CREATE TABLE IF NOT EXISTS `opencoze`.`workflow_version`
(
    `id`                  bigint unsigned NOT NULL COMMENT "workflow id",

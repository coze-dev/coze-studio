...
CREATE DATABASE `opencoze` COLLATE utf8mb4_unicode_ci;
-- Create "agent_to_database" table
CREATE TABLE `opencoze`.`agent_to_database`
(
...
CREATE TABLE `opencoze`.`agent_tool_draft`
(
...
CREATE TABLE `opencoze`.`agent_tool_version`
(
    `id`            bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `agent_id`      bigint unsigned NOT NULL DEFAULT 0 COMMENT "Agent ID",
    `plugin_id`     bigint unsigned NOT NULL DEFAULT 0 COMMENT "Plugin ID",
...
CREATE TABLE `opencoze`.`app_draft`
(
...
CREATE TABLE `opencoze`.`app_release_record`
(
...
CREATE TABLE `opencoze`.`conversation`
(
...
CREATE TABLE `opencoze`.`data_copy_task`
(
...
CREATE TABLE `opencoze`.`draft_database_info`
(
    `id`                  bigint unsigned NOT NULL COMMENT "ID",
...
CREATE TABLE `opencoze`.`knowledge`
(
...
CREATE TABLE `opencoze`.`knowledge_document`
(
    `id`             bigint unsigned NOT NULL COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`knowledge_document_review`
(
...
CREATE TABLE `opencoze`.`knowledge_document_slice`
(
    `id`           bigint unsigned NOT NULL DEFAULT 0 COMMENT "主键ID",
    `knowledge_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT "knowledge id",
...
CREATE TABLE `opencoze`.`model_entity`
(
    `id`             bigint unsigned NOT NULL COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`model_meta`
(
    `id`          bigint unsigned NOT NULL COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`online_database_info`
(
    `id`                  bigint unsigned NOT NULL COMMENT "ID",
    `app_id`              bigint unsigned NULL COMMENT "App ID",
    `space_id`            bigint unsigned NOT NULL COMMENT "Space ID",
...
(
    ...
    INDEX `idx_space_app_create_at` (`space_id`, `app_id`, `created_at`),
...
CREATE TABLE `opencoze`.`plugin_version`
(
    `id`           bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `space_id`     bigint unsigned NOT NULL DEFAULT 0 COMMENT "Space ID",
    `developer_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT "Developer ID",
...
CREATE TABLE `opencoze`.`prompt_resource`
(
...
CREATE TABLE `opencoze`.`run_record`
(
    `id`              bigint unsigned  NOT NULL COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`shortcut_command`
(
    `id`               bigint unsigned  NOT NULL AUTO_INCREMENT COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`single_agent_draft`
(
    `id`                         bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
...
CREATE TABLE `opencoze`.`single_agent_publish`
(
    `id`            bigint unsigned NOT NULL AUTO_INCREMENT COMMENT "主键id",
    `agent_id`      bigint unsigned NOT NULL DEFAULT 0 COMMENT "agent_id",
...
CREATE TABLE `opencoze`.`space_user`
(
...
CREATE TABLE `opencoze`.`template`
(
    `id`                  bigint          NOT NULL AUTO_INCREMENT COMMENT "Primary Key ID",
    `agent_id`            bigint          NOT NULL DEFAULT 0 COMMENT "Agent ID",
...
CREATE TABLE `opencoze`.`tool_draft`
(
    `id`               bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Tool ID",
    `plugin_id`        bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Plugin ID",
    `created_at`       bigint unsigned  NOT NULL DEFAULT 0 COMMENT "Create Time in Milliseconds",
...
CREATE TABLE `opencoze`.`tool_version`
(
    `id`         bigint unsigned NOT NULL DEFAULT 0 COMMENT "Primary Key ID",
    `tool_id`    bigint unsigned NOT NULL DEFAULT 0 COMMENT "Tool ID",
    `plugin_id`  bigint unsigned NOT NULL DEFAULT 0 COMMENT "Plugin ID",
...
CREATE TABLE `opencoze`.`variable_instance`
(
    `id`            bigint unsigned  NOT NULL DEFAULT 0 COMMENT "主键ID",
...
CREATE TABLE `opencoze`.`variables_meta`
(
    `id`            bigint unsigned  NOT NULL DEFAULT 0 COMMENT "主键ID",
...
(
    ...
    INDEX `idx_app_id` (`app_id`),
    INDEX `idx_creator_id` (`creator_id`),
    INDEX `idx_published_time` (`status`),
    INDEX `idx_source_id` (`source_id`),
    INDEX `idx_space_id_app_id_mode_content_type` (`space_id`, `app_id`, `mode`, `content_type`)
) CHARSET utf8mb4
  COLLATE utf8mb4_unicode_ci;
...
(
    ...
    INDEX `idx_id_referring_biz_type` (`id`, `referring_biz_type`)
) CHARSET utf8mb4
  COLLATE utf8mb4_unicode_ci;
-- Create "workflow_snapshot" table
CREATE TABLE `opencoze`.`workflow_snapshot`
(

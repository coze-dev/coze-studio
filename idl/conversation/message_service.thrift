...
service MessageService {
    ...
    message.GetMessageListResponse GetApiMessageList(1: message.GetMessageListRequest request)(api.post='/api/conversation/message/list', api.category="conversation", api.gen_path= "message")
}
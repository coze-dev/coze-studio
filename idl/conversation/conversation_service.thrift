...
service ConversationService {
    ...
    conversation.CreateConversationResponse CreateConversation(1: conversation.CreateConversationRequest request)(api.post='/api/conversation/create', api.category="conversation", api.gen_path= "conversation")

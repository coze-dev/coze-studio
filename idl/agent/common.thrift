...
struct ModelInfo {
    1: optional i64                 ModelId           (api.js_conv="true", api.body="model_id"), // 模型id
...
struct PluginInfo {
    1: optional i64 PluginId (api.js_conv="true", api.body="plugin_id"), // 插件id
    2: optional i64 ApiId    (api.js_conv="true", api.body="api_id")   , // api Id
    3: optional string ApiName (api.js_conv="true", api.body="api_name")   , // api name O项目用
}

struct WorkflowInfo {
    1: optional i64 WorkflowId (api.js_conv="true", api.body="workflow_id"), // WorkflowId
    2: optional i64 PluginId   (api.js_conv="true", api.body="plugin_id")  , // 插件id
    3: optional i64 ApiId      (api.js_conv="true", api.body="api_id")     , // api Id
    4: optional WorkflowMode FlowMode  (api.js_conv="true", api.body="flow_mode") // workflow or imageflow, 默认为workflow
    5: optional string WorkflowName (api.js_conv="true", api.body="workflow_name")   , // workflow name
...
struct FieldItem {
    ...
    5: optional i64           Id           (api.js_conv="true", api.body="id"), // 字段Id 新增为0
...
struct Agent {
    1 : i64                AgentId          (api.js_conv="true", api.body="agent_id")    ,
    ...
    11: i64                ReferenceId      (api.js_conv="true", api.body="reference_id"),
...
struct Intent{
    ...
    3: i64    NextAgentId (api.js_conv="true", api.body="next_agent_id"),
...
// bot信息
struct BotInfo {
    1 : i64                BotId            (api.js_conv="true", api.body="bot_id")      , // bot id
    ...
    6 : i64                CreatorId        (api.js_conv="true", api.body="creator_id")  , // 创建人id
    7 : i64                CreateTime       (api.js_conv="true", api.body="create_time") , // 创建时间
    8 : i64                UpdateTime       (api.js_conv="true", api.body="update_time") , // 更新时间
    9 : i64                ConnectorId      (api.js_conv="true", api.body="connector_id"), // 业务线
...
struct BotInfoForUpdate {
    1:  optional i64 BotId  (api.js_conv="true",api.body="bot_id") // bot id
    ...
    6:  optional i64 CreatorId  (api.js_conv="true", api.body="creator_id")                             // 创建人id
    7:  optional i64 CreateTime (api.js_conv="true", api.body="create_time")                             // 创建时间
    8:  optional i64 UpdateTime (api.js_conv="true", api.body="update_time")                             // 更新时间
    9:  optional i64 ConnectorId (api.js_conv="true", api.body="connector_id")                         // 业务线
...
struct AgentForUpdate {
   1: optional i64 AgentId (api.js_conv="true", api.body="id") // agw字段名做了特殊映射 注意
   ...
   11: optional i64 ReferenceId (api.js_conv="true", api.body="reference_id")

...
struct CreateDatasetRequest  {
    ...
    3: i64 space_id (agw.js_conv="str")
    4: string icon_uri
...
struct DatasetDetailResponse {
    1: map<i64, Dataset>     dataset_details (agw.js_conv="str")
...
struct ListDatasetRequest {
    ...
    3: optional i32 page
    4: optional i32 size
    5: i64 space_id (agw.js_conv="str")
...
struct DatasetFilter {
    ...
    2: optional list<i64>  dataset_ids (agw.js_conv="str") // deprecated

...
"${SCRIPT_DIR}"/tearup/setup_docker.sh || { echo -e "${RED}❌ setup_docker.sh failed${NC}"; exit 1; }
"${SCRIPT_DIR}"/tearup/setup_mysql.sh || { echo -e "${RED}❌ setup_mysql.sh failed${NC}"; exit 1; }
"${SCRIPT_DIR}"/tearup/setup_es.sh || { echo -e "${RED}❌ setup_es.sh failed${NC}"; exit 1; }
"${SCRIPT_DIR}"/tearup/setup_minio.sh || { echo -e "${RED}❌ setup_minio.sh failed${NC}"; exit 1; }

...
CUSTOM_SKIP_POST_INSTALL=true rushx --debug install -t . -t tag:rush-tools
# post-rush-install 先都不执行
# NO_STARLING=true bash $ROOT_DIR/frontend/scripts/post-rush-install.sh

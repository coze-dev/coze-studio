...
type ResourceAction struct {
	Key    ActionKey `thrift:"Key,1,required" json:"key"`
...
type ResourceInfo struct {
	...
	ResType             *ResType          `thrift:"ResType,2,optional" json:"res_type"`
	...
	PublishStatus       *PublishStatus    `thrift:"PublishStatus,11,optional" json:"publish_status"`
	...
	Actions             []*ResourceAction `thrift:"Actions,17,optional" json:"actions"`
...
type ProjectResourceAction struct {
	Key    ProjectResourceActionKey `thrift:"Key,1,required" json:"key"`
	Enable bool                     `thrift:"Enable,2,required" json:"enable"`
...
type ProjectResourceInfo struct {
	...
	Actions      []*ProjectResourceAction `thrift:"Actions,3" json:"actions"`
	ResType      ResType                  `thrift:"ResType,5" json:"res_type"`
...
type ProjectResourceGroup struct {
	GroupType    ProjectResourceGroupType `thrift:"GroupType,1" json:"group_type"`
	ResourceList []*ProjectResourceInfo   `thrift:"ResourceList,2,optional" json:"resource_list"`
}
...
type ResourceCopyFailedReason struct {
	ResID             int64   `thrift:"ResID,1" json:"ResID"`
	ResType           ResType `thrift:"ResType,2" json:"res_type"`
...
type ResourceCopyTaskDetail struct {
	...
	Status  TaskStatus        `thrift:"status,2" json:"status"`
	ResID   int64             `thrift:"res_id,3" json:"res_id"`
	ResType ResType           `thrift:"res_type,4" json:"res_type"`
	Scene   ResourceCopyScene `thrift:"scene,5" json:"scene"`

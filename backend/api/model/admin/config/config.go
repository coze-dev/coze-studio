...
const (
	...
	// To be offline, it can be used and cannot be created.
	ModelStatus_StatusPending ModelStatus = 5
	// It is offline, unusable, and cannot be created.
	ModelStatus_StatusDeleted ModelStatus = 10
)
...
func (p ModelStatus) String() string {
	...
	case ModelStatus_StatusInUse:
		return "StatusInUse"
	case ModelStatus_StatusPending:
...
func ModelStatusFromString(s string) (ModelStatus, error) {
	...
	case "StatusPending":
		return ModelStatus_StatusPending, nil
	case "StatusDeleted":

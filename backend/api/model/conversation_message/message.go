...
type GetMessageListRequest struct {
	...
	Scene     *conversation_common.Scene `thrift:"scene,7,optional" form:"scene" json:"scene,omitempty" query:"scene"`
	// 同一个bot和uid下面的不同业务情况
...
var GetMessageListRequest_Scene_DEFAULT conversation_common.Scene

func (p *GetMessageListRequest) GetScene() (v conversation_common.Scene) {
	if !p.IsSetScene() {
...
type DeleteMessageRequest struct {
	...
	Scene          *conversation_common.Scene `thrift:"scene,3,optional" form:"scene" json:"scene,omitempty" query:"scene"`
...
var DeleteMessageRequest_Scene_DEFAULT conversation_common.Scene

func (p *DeleteMessageRequest) GetScene() (v conversation_common.Scene) {
	if !p.IsSetScene() {
...
type BreakMessageRequest struct {
	...
	Scene     *conversation_common.Scene `thrift:"scene,5,optional" form:"scene" json:"scene,omitempty" query:"scene"`
}
...
var BreakMessageRequest_Scene_DEFAULT conversation_common.Scene

func (p *BreakMessageRequest) GetScene() (v conversation_common.Scene) {
	if !p.IsSetScene() {

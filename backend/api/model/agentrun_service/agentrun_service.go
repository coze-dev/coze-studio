...
func (p *AgentRunServiceClient) AgentRun(ctx context.Context, request *conversation_run.AgentRunRequest) (r *conversation_run.AgentRunResponse, err error) {
...
var AgentRunServiceAgentRunArgs_Request_DEFAULT *conversation_run.AgentRunRequest

func (p *AgentRunServiceAgentRunArgs) GetRequest() (v *conversation_run.AgentRunRequest) {
	if !p.IsSetRequest() {
...
var AgentRunServiceAgentRunResult_Success_DEFAULT *conversation_run.AgentRunResponse

func (p *AgentRunServiceAgentRunResult) GetSuccess() (v *conversation_run.AgentRunResponse) {
	if !p.IsSetSuccess() {

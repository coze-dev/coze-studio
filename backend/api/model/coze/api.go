...
import (
	...
	"code.byted.org/flow/opencoze/backend/api/model/variable"
)
...
type VariableServiceClient struct {
	*variable.VariableServiceClient
}
...
func NewVariableServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *VariableServiceClient {
	return &VariableServiceClient{
		VariableServiceClient: variable.NewVariableServiceClientFactory(t, f),
	}
}
...
func NewVariableServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *VariableServiceClient {
	return &VariableServiceClient{
		VariableServiceClient: variable.NewVariableServiceClientProtocol(t, iprot, oprot),
	}
}

func NewVariableServiceClient(c thrift.TClient) *VariableServiceClient {
	return &VariableServiceClient{
		VariableServiceClient: variable.NewVariableServiceClient(c),
	}
}
...
type VariableServiceProcessor struct {
	*variable.VariableServiceProcessor
}

func NewVariableServiceProcessor(handler VariableService) *VariableServiceProcessor {
	self := &VariableServiceProcessor{variable.NewVariableServiceProcessor(handler)}
	return self
}
...
type AgentServiceProcessor struct {
	*agent.AgentServiceProcessor
}

func NewAgentServiceProcessor(handler AgentService) *AgentServiceProcessor {
	self := &AgentServiceProcessor{agent.NewAgentServiceProcessor(handler)}
	return self
}

...
func GetBasicConfiguration(ctx context.Context, c *app.RequestContext) {
	baseConfig, err := bizConf.Shard().GetBaseConfig(ctx)
	if err != nil {
...
func SaveBasicConfiguration(ctx context.Context, c *app.RequestContext) {
	...
	err = bizConf.Shard().SaveBaseConfig(ctx, req.Configuration)
	if err != nil {
...
func GetKnowledgeConfig(ctx context.Context, c *app.RequestContext) {
	var err error
	var req config.GetKnowledgeConfigReq
	err = c.BindAndValidate(&req)
	if err != nil {
		c.String(consts.StatusBadRequest, err.Error())
		return
...
// @router /api/admin/config/knowledge/update [POST]
...
func GetModelList(ctx context.Context, c *app.RequestContext) {
	...
	modelList, err := bizConf.Shard().GetProviderModelList(ctx)
	if err != nil {
...
func CreateModel(ctx context.Context, c *app.RequestContext) {
	...
	modelBuilder, err := modelbuilder.NewModelBuilder(req.ModelClass, req.Connection)
	if err != nil {
		invalidParamRequestResponse(c, fmt.Sprintf("create model builder failed: %v", err))
		return
	}

	chatModel, err := modelBuilder.Build(ctx)
	if err != nil {
	...
	id, err := bizConf.Shard().CreateModel(ctx, req.ModelClass, req.ModelName, req.Connection)
	if err != nil {
...
func DeleteModel(ctx context.Context, c *app.RequestContext) {
	...
	err = bizConf.Shard().DeleteModel(ctx, req.ID)
	if err != nil {

...
import (
	...
	ocean_cloud_modelmgr "github.com/coze-dev/coze-studio/backend/api/router/ocean/cloud/modelmgr"
...
func GeneratedRegister(r *server.Hertz) {
	...
	ocean_cloud_modelmgr.Register(r)
...
func manualRegisterImportExport(r *server.Hertz) {
	...
	// 模型管理接口现在由 ocean_cloud_modelmgr.Register(r) 自动注册，不需要手动注册了
}

...
func (c *ModelConfig) CreateModel(ctx context.Context, modelClass developer_api.ModelClass, modelShowName string, conn *config.Connection) (int64, error) {
	id, err := c.createModel(ctx, nil, modelClass, modelShowName, conn)
	if err != nil {
		return 0, err
	}
...
func (c *ModelConfig) createModel(ctx context.Context, id *int64, modelClass developer_api.ModelClass, modelShowName string, conn *config.Connection) (int64, error) {
	if conn == nil {

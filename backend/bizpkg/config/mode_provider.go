...
func ModelProviders() []*config.ModelProvider {
	return []*config.ModelProvider{
		...
		},
		{
			...
			Description: &config.I18nText{
				ZhCn: "Deepseek 模型简介",
				EnUs: "deepseek model description",
			},

...
// Make2 casts function f with 2 arguments and 1 return value to Func2
func Make2[T1, T2, R any](f Func2[T1, T2, R]) Func2[T1, T2, R] {
	return f
}
...
// Make3 casts function f with 3 arguments and 1 return value to Func3
func Make3[T1, T2, T3, R any](f Func3[T1, T2, T3, R]) Func3[T1, T2, T3, R] {
	return f
}
...
// Make4 casts function f with 4 arguments and 1 return value to Func4
func Make4[T1, T2, T3, T4, R any](f Func4[T1, T2, T3, T4, R]) Func4[T1, T2, T3, T4, R] {
	return f
}
...
// Make5 casts function f with 5 arguments and 1 return value to Func5
func Make5[T1, T2, T3, T4, T5, R any](f Func5[T1, T2, T3, T4, T5, R]) Func5[T1, T2, T3, T4, T5, R] {
	return f
}
...
// Make6 casts function f with 6 arguments and 1 return value to Func6
func Make6[T1, T2, T3, T4, T5, T6, R any](f Func6[T1, T2, T3, T4, T5, T6, R]) Func6[T1, T2, T3, T4, T5, T6, R] {
	return f
}
...
// Make7 casts function f with 7 arguments and 1 return value to Func7
func Make7[T1, T2, T3, T4, T5, T6, T7, R any](f Func7[T1, T2, T3, T4, T5, T6, T7, R]) Func7[T1, T2, T3, T4, T5, T6, T7, R] {
	return f
}
...
// Make8 casts function f with 8 arguments and 1 return value to Func8
func Make8[T1, T2, T3, T4, T5, T6, T7, T8, R any](f Func8[T1, T2, T3, T4, T5, T6, T7, T8, R]) Func8[T1, T2, T3, T4, T5, T6, T7, T8, R] {
	return f
}
...
// Make9 casts function f with 9 arguments and 1 return value to Func9
func Make9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R any](f Func9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R]) Func9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R] {
	return f
}
...
// Make10 casts function f with 10 arguments and 1 return value to Func10
func Make10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R any](f Func10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R]) Func10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R] {
	return f
}

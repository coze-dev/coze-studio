...
func (p *PromptApplicationService) UpsertPromptResource(ctx context.Context, req *prompt.UpsertPromptResourceRequest) (resp *prompt.UpsertPromptResourceResponse, err error) {
...
func (p *PromptApplicationService) createPromptResource(ctx context.Context, req *prompt.UpsertPromptResourceRequest) (resp *prompt.UpsertPromptResourceResponse, err error) {
	...
	return &prompt.UpsertPromptResourceResponse{
		Data: &prompt.ShowPromptResource{
			ID: promptID,
		},
		Code: 0,
	}, nil
...
func (*PromptApplicationService) updatePromptResource(ctx context.Context, req *prompt.UpsertPromptResourceRequest) (resp *prompt.UpsertPromptResourceResponse, err error) {
	promptID := req.Prompt.GetID()

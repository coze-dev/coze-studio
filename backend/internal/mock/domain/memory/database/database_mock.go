...
//
//	mockgen -destination ../../../internal/mock/domain/memory/database/database_mock.go --package database -source interface.go
//
...
func (m *MockDatabase) CreateDatabase(ctx context.Context, req *database.CreateDatabaseRequest) (*database.CreateDatabaseResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDatabase", ctx, req)
	ret0, _ := ret[0].(*database.CreateDatabaseResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

...
func (m *MockPluginService) GetSaasPluginInfo(ctx context.Context, pluginID int64) (*entity.PluginInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSaasPluginInfo", ctx, pluginID)
	ret0, _ := ret[0].(*entity.PluginInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPluginServiceMockRecorder) GetSaasPluginInfo(ctx, pluginID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSaasPluginInfo", reflect.TypeOf((*MockPluginService)(nil).GetSaasPluginInfo), ctx, pluginID)
}
...
func (m *MockPluginService) ListSaasPluginCategories(ctx context.Context, req *dto0.ListPluginCategoriesRequest) (*dto0.ListPluginCategoriesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSaasPluginCategories", ctx, req)
	ret0, _ := ret[0].(*dto0.ListPluginCategoriesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPluginService) ListSaasPluginProducts(ctx context.Context, req *dto0.ListPluginProductsRequest) (*dto0.ListPluginProductsResponse, error) {
	m.ctrl.T.Helper()

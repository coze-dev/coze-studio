...
func TestOperatorWillAccept(t *testing.T) {
	testCases := []struct {
		...
		// OperatorEqual
		{
			...
			leftType:  reflect.TypeOf(0),
			rightType: reflect.TypeOf(0),
			wantErr:   false,
		},
		{
			name:      "OperatorEqual_Int64Mismatch",
			operator:  OperatorEqual,
			leftType:  reflect.TypeOf(0),
		...
		{
			name:      "OperatorNotEqual_Float64Mismatch",
			operator:  OperatorNotEqual,
			leftType:  reflect.TypeOf(float64(0)),
			rightType: reflect.TypeOf(0),
			wantErr:   true,
		...
		{
			name:      "OperatorEmpty_InvalidType",
			operator:  OperatorEmpty,
			leftType:  reflect.TypeOf(0),
			rightType: nil,
			wantErr:   true,
		...
		{
			name:      "OperatorNotEmpty_InvalidType",
			operator:  OperatorNotEmpty,
			leftType:  reflect.TypeOf(0),
			rightType: nil,
			wantErr:   true,
		...
		{
			name:      "OperatorGreater_Int64Mismatch",
			operator:  OperatorGreater,
			leftType:  reflect.TypeOf(0),
			rightType: reflect.TypeOf(float64(0)),
			wantErr:   true,
		...
		{
			name:      "OperatorGreaterOrEqual_Float64Mismatch",
			operator:  OperatorGreaterOrEqual,
			leftType:  reflect.TypeOf(float64(0)),
			rightType: reflect.TypeOf(0),
			wantErr:   true,
		...
		{
			name:      "OperatorLesser_Int64Mismatch",
			operator:  OperatorLesser,
			leftType:  reflect.TypeOf(0),
			rightType: reflect.TypeOf(float64(0)),
			wantErr:   true,
		...
		{
			name:      "OperatorLesserOrEqual_Float64Mismatch",
			operator:  OperatorLesserOrEqual,
			leftType:  reflect.TypeOf(float64(0)),
			rightType: reflect.TypeOf(0),
			wantErr:   true,
		...
		},
		{
			...
			operator:  OperatorNotContain,
			leftType:  reflect.TypeOf([]int{}),
			rightType: reflect.TypeOf(int(0)),
			wantErr:   false,
		},
		{
		...
		{
			name:      "OperatorContainKey_Struct",
			operator:  OperatorContainKey,
			leftType:  reflect.TypeOf(struct{}{}),
			rightType: reflect.TypeOf(""),
			wantErr:   false,
		...
		{
			name:      "OperatorNotContainKey_Struct",
			operator:  OperatorNotContainKey,
			leftType:  reflect.TypeOf(struct{}{}),
			rightType: reflect.TypeOf(""),
			wantErr:   false,

...
const (
	...
	OperatorIsTrue               = "true"
	OperatorIsFalse              = "false"
	OperatorLengthGreater        = "len >"
	OperatorLengthGreaterOrEqual = "len >="
	OperatorLengthLesser         = "len <"
	OperatorLengthLesserOrEqual  = "len <="
	OperatorContain              = "contain"
	OperatorNotContain           = "not_contain"
	OperatorContainKey           = "contain_key"
	OperatorNotContainKey        = "not_contain_key"
)

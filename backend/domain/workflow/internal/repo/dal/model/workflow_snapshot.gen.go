...
type WorkflowSnapshot struct {
	WorkflowID int64  `gorm:"column:workflow_id;primaryKey;comment:workflow id this snapshot belongs to" json:"workflow_id"` // workflow id this snapshot belongs to
	CommitID   string `gorm:"column:commit_id;primaryKey;comment:the commit id of the workflow draft" json:"commit_id"`      // the commit id of the workflow draft

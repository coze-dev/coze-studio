...
const TableNameAppDynamicConversionOnline = "app_dynamic_conversion_online"

// AppDynamicConversionOnline mapped from table <app_dynamic_conversion_online>
...
// TableName AppDynamicConversionOnline's table name
func (*AppDynamicConversionOnline) TableName() string {
	return TableNameAppDynamicConversionOnline
}

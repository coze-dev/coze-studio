...
const TableNameAppDynamicConversionDraft = "app_dynamic_conversion_draft"

// AppDynamicConversionDraft mapped from table <app_dynamic_conversion_draft>
...
// TableName AppDynamicConversionDraft's table name
func (*AppDynamicConversionDraft) TableName() string {
	return TableNameAppDynamicConversionDraft
}

...
// NodeExecution mapped from table <node_execution>
type NodeExecution struct {
	...
	CostUnit     string  `gorm:"column:cost_unit;comment:unit of money cost" json:"cost_unit"`                                                            // unit of money cost
	...
	Index        int64   `gorm:"column:index;comment:loop or batch's execution index" json:"index"`                                                       // loop or batch's execution index

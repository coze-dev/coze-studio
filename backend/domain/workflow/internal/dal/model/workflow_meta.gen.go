...
type WorkflowMeta struct {
	...
	Status      int32          `gorm:"column:status;not null;comment:1不可发布 2可发布 3已发布 4删除" json:"status"`                                                                                                                                                                                                                 // 1不可发布 2可发布 3已发布 4删除

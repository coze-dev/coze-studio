...
func (i *impl) ListNodeMeta(ctx context.Context, nodeTypes map[int]bool) (map[string][]*entity.NodeTypeMeta, map[string][]*entity.PluginNodeMeta, map[string][]*entity.PluginCategoryMeta, error) {
	...
	shouldInclude := func(nodeType int) bool {

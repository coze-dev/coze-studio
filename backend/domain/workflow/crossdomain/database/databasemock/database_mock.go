...
func (mr *MockDatabaseOperatorMockRecorder) Delete(arg0, arg1 interface{}) *gomock.Call {
...
func (mr *MockDatabaseOperatorMockRecorder) Execute(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDatabaseOperatorMockRecorder) Insert(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDatabaseOperatorMockRecorder) Query(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDatabaseOperatorMockRecorder) Update(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

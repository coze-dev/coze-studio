...
import (
	...
	"code.byted.org/data_edc/workflow_engine_next/domain/memory/variables/internal/dal/model"
	"code.byted.org/data_edc/workflow_engine_next/domain/memory/variables/internal/dal/query"

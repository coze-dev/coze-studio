...
func newPluginOauthAuth(db *gorm.DB, opts ...gen.DOOption) pluginOauthAuth {
	...
	_pluginOauthAuth.TokenExpiresIn = field.NewInt64(tableName, "token_expires_in")
...
type pluginOauthAuth struct {
	...
	TokenExpiresIn     field.Int64  // Token Expires in Milliseconds
...
func (p *pluginOauthAuth) updateTableName(table string) *pluginOauthAuth {
	...
	p.TokenExpiresIn = field.NewInt64(table, "token_expires_in")
...
func (p *pluginOauthAuth) fillFieldMap() {
	...
	p.fieldMap["token_expires_in"] = p.TokenExpiresIn

...
type AppService interface {
	...
	GetAPPPublishRecord(ctx context.Context, req *GetAPPPublishRecordRequest) (resp *GetAPPPublishRecordResponse, err error)
...
type GetAPPPublishRecordResponse struct {
	Published bool

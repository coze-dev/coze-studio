...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.SpaceID = field.NewInt64(tableName, "space_id")
	_app.OwnerID = field.NewInt64(tableName, "owner_id")
	_app.IconURI = field.NewString(tableName, "icon_uri")
	_app.Name = field.NewString(tableName, "Name")
	_app.Desc = field.NewString(tableName, "desc")
	_app.ConnectorID = field.NewInt64(tableName, "connector_id")
	_app.PublishConfig = field.NewField(tableName, "publish_config")
	_app.Version = field.NewString(tableName, "version")
	_app.PublisherID = field.NewInt64(tableName, "publisher_id")
	_app.VersionDesc = field.NewString(tableName, "version_desc")
	_app.PublishAt = field.NewInt64(tableName, "publish_at")

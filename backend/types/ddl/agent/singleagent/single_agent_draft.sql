CREATE TABLE IF NOT EXISTS `single_agent_draft` (
    ...
    `create_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Create Time in Milliseconds',
    `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update Time in Milliseconds',

CREATE TABLE `workflow_snapshot` (
                                     ...
                                     `input_params` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'input parameter info',
                                     `output_params` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'output parameter info',
